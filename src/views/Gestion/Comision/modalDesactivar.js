...
import { Modal, Row, Card, Button, CardTitle, Col } from "reactstrap";
...
const ModalDesactivar = (props) => {
    ...
    const desactivando = async (datos) => {
        ...
        const respuesta = await axios.post(backend + 'deactivateFormaPago', data);
        ...
        >
            <Card body >
                <Row style={{ margin: "50px", textAlign: "center" }}>
                    <h3>¿Esta seguro que desea {desactivar ? <span style={{ color: "red" }}>DESACTIVAR</span> : <span style={{ color: "red" }}>ACTIVAR</span>} la forma de Pago {datos.nombre}?</h3>
                </Row>
