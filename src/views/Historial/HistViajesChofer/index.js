...
const HistorialViajesChofer = () => {
  ...
  const traerDatos = async () => {
    const histviajes = await axios.get(backend + "getHistorialViajesChofer");
        ...
        <Card className="iq-card">
          <CardHeader>
            <CardTitle className="iq-header-title">
              <Row>
                <Col lg="6">
                  <h4 className="card-title">Historial de Viajes por chofer</h4>
                </Col>
...
export default HistorialViajesChofer;
