...
const RecargasAprobadas = () => {
  ...
  const traerDatos = async () => {
    const resp = await axios.get(backendMiRuta + "admin/recarga/listar/A");
        ...
        <Card className="iq-card">
          <CardHeader>
            <CardTitle className="iq-header-title">
              <Row>
                <Col lg="6">
                  <h4 className="card-title">Mantenimiento Recargas</h4>
                </Col>
              </Row>
            </CardTitle>
          </CardHeader>
...
export default RecargasAprobadas;
